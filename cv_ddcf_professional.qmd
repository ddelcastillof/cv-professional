...
\textbf{Packages:} tidyverse, ggplot2, meta/metafor, lme4, survival, geepack, gam, lavaan, sf, rJAGS, rstan, Pandas, Matplotlib, NumPy, MR-BRT (GBD Study estimation), amongst other tools. \
\textbf{Core Competencies:} Data analysis, teamwork, problem solving, science communication, mentorship
