...
\vspace{-1.5em}
\textcolor{gray}{\rule{\textwidth}{0.5pt}}
Health economist specializing in economic evaluation, real-world evidence generation, cost-effectiveness modeling, \& health technology assessment for healthcare decision-making.
...
\begin{itemize}
  \item Developed Bayesian priors for a Bayesian hierarchical meta‑regression model to estimate prevalence, incidence, and clinical‐outcome occurrence of lower‑respiratory‑tract infections across 80 countries, informing GBD 2025 inputs.
  ...
  \item Estimated population-attributable fractions and standardized mortality ratios using the overlap between socially-excluded groups.
\end{itemize}
} \\
\\
...
\begin{itemize} 
  ...
  \item Analyzed engagement and outreach data into visualization tools and summary tables, enabling program managers to make adjustments to recruitment strategies.
\end{itemize}
} \\
\\
...
\begin{itemize}
  ...
  \item Contributed to research grant proposals in noncommunicable disease epidemiology by conducting preliminary data analysis on clinical, demographic, and biological biomarkers, supporting proposals worth \$300\,k in competitive funding.
  \item Co-authored 5 scientific manuscripts which included longitudinal data analyses, systematic reviews, and machine learning models.
\end{itemize}
} \\
\end{longtable}
