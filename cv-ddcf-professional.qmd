...
\centering
\faLinkedin \href{https://www.linkedin.com/in/darwin-del-castillo/}{/darwin-del-castillo} \\ 
...
\item Estimated population attributable fractions among substance drug abusers, prisoners, and people experiencing homelessness from 22 high-income countries using previously-calculated SMR as inputs.
\end{itemize}
} \\
\\
...
\item Co-authored peer-reviewed manuscripts, communicating complex analytical findings for academic and policy audiences.
\end{itemize}
} \\
