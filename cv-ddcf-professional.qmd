...
\item \textbf{Other:} Linux/Unix, HPC (Slurm), \LaTeX, Markdown, VSCode, Jupyter Notebooks, Quarto, Docker, Git, Shiny (R)
\end{itemize}
\end{minipage}
...
\item Developed and executed Bayesian MCMC workflows to quantify overlap among homeless populations, substance users, and incarcerated individuals across 22 high-income countries, producing real-world evidence for targeted health burden stratification.
...
\textcolor{darkgray}{\rule{\textwidth}{0.5pt}}
\begin{longtable}{>{\raggedright\arraybackslash}p{4cm} p{14cm}}
\textbf{Dec 2024 - current} & \textbf{Lecturer: Introduction to Epidemiology.} Universidad Científica del Sur. I'm teaching fourth-year medical students basic concepts of clinical epidemiology with focus in basic study designs and identification of bias.
\end{longtable}
