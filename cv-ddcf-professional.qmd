...
\begin{itemize}
\item Pooling epidemiological data of lower respiratory tract infections due to human metapneumovirus globally and across all ages from 2010 to 2023 using a Bayesian meta-regression tool.
