...
\vspace{-5pt}
\par\centering{\textit{Email:} \href{mailto:ddelcastillo.f@gmail.com}{ddelcastillo.f@gmail.com}}
...
```
\par\centering \faLinkedin \href{https://www.linkedin.com/in/darwin-del-castillo-md/}{/darwin-del-castillo} | \faGithub \href{https://github.com/ddelcastillof}{/ddelcastillof}
\vspace{-2.5pt}
...
\begin{itemize}
\item Pooled epidemiological data of lower respiratory tract infections using the package meta in R and internal Python functions.
\item Created cleaning pipelines for EHR data from Colombia using Python (pandas, pydantic, etc.).
\item Estimated the overlap proportion between homelessness, substance drug abusers, and prisoners in high-income countries using Markov Chain Monte Carlo algorithms with R.
\end{itemize}
} \\
...
\begin{longtable}{p{14cm}>{\raggedleft\arraybackslash}p{4cm}}
\textbf{Peruvian College of Physicians}, Membership No. 94534 &  \textbf{Aug 2021 – Aug 2026} \\
& \\
\textbf{National Registry of Investigators, RENACYT}, Investigator Level VII (P0160977) & \textbf{Feb 2024 – Feb 2026} \\
& \\
\textbf{CITI Program}, Good Clinical Practice and ICH (GCP), Credential ID 65079238 & \textbf{Sep 2023 – Mar 2026}
\end{longtable}
...
#| include: false
#| echo: false
\item \textbf{Data management and wrangling:} REDCap
