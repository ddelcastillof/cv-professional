...
\begin{itemize}
\item Pooled epidemiological estimates of lower respiratory tract infections from ~80 countries between 2010 and 2023 using the R package meta and internal Bayesian regression models.
\item Estimated the overlap proportion between homeless, substance drug abusers, and prisoners using a Bayesian Markov Chain Monte Carlo model.
\item Created cleaning pipelines for inpatient and outpatient data from Ecuador and Colombia with Python libraries. 
\end{itemize}
} \\
...
\item Designed a mixed-methods data-analysis protocol to assess the effectiveness of implementation strategies for pediatric burn care in a Peruvian healthcare setting.
...
\begin{itemize}
\item \textbf{Programming languages:} R (tidyverse, meta, rJAGS), Python (pandas, NumPy, black, pytest), bash
